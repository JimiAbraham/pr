                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p class="mb-2">Email Address <span class="text-primary">{{ $user->email}}</span></p>
                                                                <p class="mb-4">Date Of Birth: <span class="text-primary">{{ $user->DOB}}</span></p>
                                                                <p class="mb-4">Address: <span class="text-primary">{{ $user->address}}</span></p>
                                                                <p class="mb-4">Marital Status: <span class="text-primary">{{ $user->marital}}</span></p>
                                                                <p class="mb-4">Profession: <span class="text-primary">{{ $user->job}}</span></p>
